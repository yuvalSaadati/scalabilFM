...
class SpectralReduction:
    ...
    def _fit(self, X: torch.Tensor, y: torch.Tensor, FL: torch.Tensor, is_point_cloud, W_:torch.Tensor = None, A:torch.Tensor = None) -> np.ndarray:
        ...
        self._spectralnet.fit(X, y, FL, is_point_cloud, W_, A)
    ...
    def fit_transform(self, X: torch.Tensor, y: torch.Tensor = None, FL: torch.Tensor = None, is_point_cloud = True, W_:torch.Tensor = None, A:torch.Tensor = None) -> np.ndarray:
        ...
        """
        self._fit(X, y, FL, is_point_cloud, W_, A)
